    ...
    return(
      <div className="question">
        ...
        <div className="button-container">
          ...
          <Link to="/finish-quiz" state={{answeredQuestions:this.state.numberofAnsweredQuestions,score:this.state.score,correctAnswer:this.state.correctAnswers,totalQuestions:this.state.questions.length, wrongAnswer:this.state.wrongAnswers}}><button className="finish">Finish
          </button>
          </Link>
        </div>
